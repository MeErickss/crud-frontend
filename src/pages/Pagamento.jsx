...
import { PagamentoC } from "../components/PagamentoC"
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex-grow bg-gray-50">
                ...
                <main className="p-10">
                    <h1 className="text-3xl"><strong>Detalhes de Pagamento</strong></h1>
