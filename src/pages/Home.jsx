    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex-grow bg-gray-50">
                ...
                <main className="flex flex-wrap justify-around gap-4 p-4">
                    <div className="w-1/5 h-48 rounded-lg bg-blue-200 flex flex-col text-right p-5 justify-center">
                        <div className="text-left">
                            <svg className="mb-5" width="60" height="48" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-xl">Estudantes</p>
                        </div>
                        <span className="text-3xl font-bold">243</span>
                    </div>
                    <div className="w-1/5 h-48 rounded-lg bg-pink-300 flex flex-col text-right p-5 justify-center">
                        <div className="text-left">
                            <svg className="mb-5" width="60" height="48" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <defs>
                                    <clipPath id="clip0_17_26">
                                        <rect width="60" height="48" fill="white" transform="matrix(-1 0 0 1 12 0)" />
                                    </clipPath>
                                </defs>
                            </svg>
                    ...
                    <div className="w-1/5 h-48 rounded-lg bg-yellow-100 flex flex-col text-right p-5 justify-center">
                        <div className="text-left">
                            <svg className="mb-5" width="60" height="48" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="text-3xl font-bold">44444</span>
                    </div>
                    <div className="w-1/5 h-48 rounded-lg bg-yellow-600 flex flex-col text-right p-5 justify-center">
                        <div className="text-left">
                            <svg className="mb-5" width="60" height="48" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
