...
export function EstudanteC(){
    return(
            <div className="flex w-11/12 h-20 rounded-lg px-5 justify-between items-center text-sm mb-10 text-white bg-gray-900">
                <div
                    className="w-16 h-16 rounded-lg bg-cover bg-center border-4 border-white"
